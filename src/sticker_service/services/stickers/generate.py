...
def build_sheet_prompt(style: Style, captions: list[str], age_clause: str) -> str:
    ...
    return (
        ...
        f"списке идей, нарисованная кавычка = брак; плашка надписи и её белая "
        f"обводка сливаются с обводкой рисунка в одну цельную наклейку, а не висят "
        f"отдельным островом — при этом сам текст рисунок не перекрывает; надпись "
