...
PROMPT = (
    ...
    "single — на фото ровно один живой человек в кадре; отражение в зеркале, "
    "человек на постере/картине/фото на стене, статуя, кукла или манекен за "
    "отдельного человека НЕ считаются."
)
