...
# Owner's honesty rule (2026-06-12): expectations are managed UP FRONT — the
# full version lives on the onboarding screen and /help, a short echo sits on
# the review screen right before «✅ Создать».
QUALITY_NOTE = (
    "🎨 <b>Про качество:</b> модель не идеальна — картинки могут не совпасть "
    "с тем, как ты их себе представлял, встречаются ошибки в содержании и "
    "подписях. Обещать их полное отсутствие мы не можем, но постоянно "
    "работаем над качеством. Заметил косяк — напиши /report, это очень помогает."
)
...
HELP = (
    ...
    "/history — история заказов: какие стикеры ты просил\n"
