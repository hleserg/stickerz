...
- **[AGENTS.md](../AGENTS.md)** — the contract for agents and humans (read first).
...
- `architecture/` — system overview and decision records
- `development/` — how we build here
- `features/` — per-feature user guides (EN + `-ru.md`)
- `ops/` — runbooks
